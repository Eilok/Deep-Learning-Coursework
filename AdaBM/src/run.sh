...
edsr_vit() {
    ...
    --w_bitloss 50.0 --w_sktloss 10.0 --imgwise --layerwise --bac \
    --img_percentile 10.0 --layer_percentile 30.0 \
    --save edsrbaseline_x$scale/w$3a$2-adabm-nonfq-vit \
    --seed 1 \
    # 
}
...
edsr_ft() {
    ...
    --w_bitloss 50.0 --w_sktloss 10.0 --imgwise --layerwise --bac \
    --img_percentile 10.0 --layer_percentile 30.0 \
    --save edsrbaseline_x$scale/w$3a$2-adabm-nonfq-ft \
    --seed 1 \
    # 
}
...
edsr_vit_eval() {
    ...
    --save edsrbaseline_x$scale/w$3a$2-adabm-nonfq-vit \
    --test_patch --test_patch_size 96 --test_step_size 96 \
    # --pre_train ../pretrained_model/edsr_baseline_x$scale-w$3a$2-adabm-nonfq-ft.pt \
    --pre_train ../experiment/edsrbaseline_x$scale/w$3a$2-adabm-nonfq-vit/model/checkpoint.pt \
    # --save_results \
}
...
edsr_ft_eval() {
    ...
    --test_patch --test_patch_size 96 --test_step_size 96 \
    # --pre_train ../pretrained_model/edsr_baseline_x$scale-w$3a$2-adabm-nonfq-ft.pt \
    --pre_train ../experiment/edsrbaseline_x$scale/w$3a$2-adabm-nonfq-ft/model/checkpoint.pt \
    # --save_results \
}
